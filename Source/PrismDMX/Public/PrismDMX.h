...
/**
 * Custom safe DMX Modulator with Pixel mapping toggle and attribute calculations.
 * Designed to prevent crashes during out-of-bounds universe access.
 */
UCLASS()
...
private:
    ...
    // Performs IsValid and Array Bounds checks to guarantee crash safety.
